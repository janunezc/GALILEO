...
if (val >300 and val <610)  digitalWrite(trans_base, HIGH),digitalWrite (warning, LOW); // If the sensor outcome is higher than 300 and less than 610, then activates the transistor and disable the warning pin. 
  else digitalWrite(trans_base, LOW);

if (val > 610)  digitalWrite(trans_base, LOW), digitalWrite (warning, HIGH); // If the sensor outcome is higher than 610, then deactivates the transistor and activates the protection using the warning pin. 
